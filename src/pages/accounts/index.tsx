  ...
  return (
    ...
    >
      ...
      <div className="flex items-center w-full">
       <span onClick={()=>navigate(-1)} className="!cursor-pointer"><LeftArrowIcon  /></span>
      ...
      <div className="rounded-[0.625rem] p-[1rem] mt-[2.5rem] w-full bg-content1-foreground/5 flex flex-col border-[0.5px] border-content1-100 gap-[1rem]">
        ...
        <p onClick={deleteAccount} className="text-body w-fit cursor-pointer font-sans text-danger-50">
          Delete My Account
        </p>
      </div>
    </RootLayout>
