...
export const Ready = () => {
  const { roadmapData, roadmapMilestones } = useOnboardingStore();
   ...
   const { personalInfo: { name } } = useAccountStore();
  const navigate = useNavigate();
  return (
    <div className="flex flex-col h-screen overflow-hidden text-content1-foreground relative">

      {/* Header */}
      <div className="absolute top-0 w-full flex items-center gap-4 py-5 pb-4 px-4 z-20 bg-background-200
      ...
      {/* CTA */}
      <div className="absolute bottom-0 w-full bg-background-200 pt-5 pb-2 px-4
